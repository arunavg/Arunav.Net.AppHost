...
namespace Arunav.Net.TestApp
{
    internal static class HtmlTags
    {
        ...
        public const string DivMessageLabel = "\n\t\t\t\t<div style='text-align: center; height: 28px;'>\n\t\t\t\t\t<span id='lblMessage' style='color:Red;'></span>\n\t\t\t\t</div>\n\t\t\t\t<div style='font-size: 11px; padding: 8px;'>Arunav.Net.AppHost is a lightweight web server for hosting asp.net web apps that contain http module and handlers. It supports GET and POST methods.<br/>Use this form to test GET / POST.</div>";
